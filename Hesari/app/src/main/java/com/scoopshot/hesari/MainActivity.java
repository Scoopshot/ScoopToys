...
{
    private static final String TAG = "Hesari.MainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerFragment.setUp(R.id.navigation_drawer, dl);
        dl.closeDrawer(Gravity.LEFT);

        svl = ScoopshotSDK.getScoopshotViewLauncher(this, R.id.container);
        ssv = svl.getScoopshotView();
        ScoopshotSDK.setScoopshotView(ssv);
